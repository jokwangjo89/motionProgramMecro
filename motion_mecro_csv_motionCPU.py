...
from mecro import MotionConfigurator,add_to_address,add_to_bit_address,add_bit_offset
excel_file ='TEST_MOTION_MECRO_MAP.xlsx'
...
################################# 2. D6부터 아래로 채울 데이터################################################
#wb = Workbook()
wb= load_workbook("motion_mecro_result1.xlsx")
ws = wb.active
ws.title = "Exported"
data = []
last_row = 2
...
for j in range(10):
    ...
    if str(axis_no).isdigit():
        ...
        data.append("")
        #MOTOR STATE
        last_row=motion.ladder_mecro.export_partial_to_excel(ws,last_row,"STATE") 
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_status_recv_adr('START',axis_no, 11))
        ...
        data.append("")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_status_recv_adr('START',axis_no, 12))
        ...
        data.append("")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_status_recv_adr('START',axis_no, 14))
        ...
        data.append("")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_status_recv_adr('START',axis_no, 7))
        data.append("K0")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_monitor_recv_adr('START',axis_no,7))
        ...
        data.append("")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_status_recv_adr('START',axis_no, 8))
        ...
        data.append("")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_status_recv_adr('START',axis_no, 9))
        ...
        data.append("")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_status_recv_adr('START',axis_no, 10))
        ...
        data.append("")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_status_recv_adr('START',axis_no, 15))
        ...
        data.append("")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_SFC_home_recv_adr('START',axis_no, axis_no))
        ...
        data.append("")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_SFC_pos_recv_adr('START',axis_no, axis_no))
        ...
        data.append("")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_status_recv_adr('START',axis_no, 6))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+axis_address_offset),10))
        data.append("")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),23+axis_address_offset))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+axis_address_offset),11))
        cell = f'A{last_row}'
        ws[cell] = 'Origin'
        last_row=last_row+1
        #MOTOR ORIGIN
        last_row=motion.ladder_mecro.export_partial_to_excel(ws,last_row,"ORIGIN") 
        data.append("")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("F10")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),29+axis_address_offset),1))
        ...
        data.append("")
        #POSITION_INTERLOCK
        last_row=motion.ladder_mecro.export_partial_to_excel(ws,last_row,"POSITION_INTERLOCK") 
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),20+5+axis_address_offset))
        ...
        data.append("")
        #POSITION_BIT
        last_row=motion.ladder_mecro.export_partial_to_excel(ws,last_row,"POSITION_BIT") 
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),20+2+axis_address_offset))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+ 2 +axis_address_offset),0))
        ...
        for i in range(1, 16):
            ...
            data.append("")
            data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+ 2 +axis_address_offset),i))
            data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),30+ 1 +axis_address_offset),i))
            data.append("")
            data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+ 4 +axis_address_offset),i))
            data.append("")
        ...
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append(motion.motor_motion_send_adr.get_motion_axis_Command_send_adr('START',axis_no, 0))
        ...
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+11+axis_address_offset))
        data.append("K1")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+ 0 +axis_address_offset),9))
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),20+8+axis_address_offset))
        cell = f'A{last_row}'
        ws[cell] = 'POSITION_START'
        last_row=last_row+1
        data.append("")
        #POSITION_START
        last_row=motion.ladder_mecro.export_partial_to_excel(ws,last_row,"POSITION_START") 
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append(motion.motor_motion_send_adr.get_motion_axis_Command_send_adr('START',axis_no, 2))
        data.append(motion.motor_motion_send_adr.get_motion_axis_Command_send_adr('START',axis_no, 3))
        data.append("")
        data.append("K0")
        ...
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),20+4+axis_address_offset))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+ 6 +axis_address_offset),0))
        data.append(motion.motor_motion_send_adr.get_motion_axis_SFC_home_Send_adr('START',axis_no, axis_no))
        data.append("K9001")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+10+axis_address_offset))
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+ 0 +axis_address_offset),3))
        ...
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+ 0 +axis_address_offset),8))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+ 0 +axis_address_offset),9))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+ 0 +axis_address_offset),6))
        data.append("")
        data.append(motion.motor_motion_send_adr.get_motion_axis_SFC_home_Send_adr('START',axis_no, axis_no))
        for i in range(1, 16):
            data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),20+6+axis_address_offset))
        ...
        data.append("")
        #POSITION_MOVEMENT
        last_row=motion.ladder_mecro.export_partial_to_excel(ws,last_row,"POSITION_MOVEMENT") 
        data.append("K1")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+6+axis_address_offset))
        data.append("K0")
        ...
        data.append(motion.motor_motion_send_adr.get_motion_axis_position_send_adr('START',axis_no, 0))
        data.append("K2")
        data.append(motion.motor_param_adr.get_param_adr('DECTIME',axis_no))
        data.append(motion.motor_motion_send_adr.get_motion_axis_position_send_adr('START',axis_no, 2))
        data.append("K2")
        data.append("")
        data.append("SM400")
        data.append("")
        ...
        data.append("")
        data.append("ZR186")
        data.append(motion.motor_motion_send_adr.get_motion_axis_position_send_adr('START',axis_no, 4))
        data.append("")
        data.append("SM400")
        ...
        data.append(motion.motor_pos_adr.get_pos_adr('TARGET',axis_no, 1)+'Z4')
        data.append(motion.motor_pos_adr.get_pos_adr('TARGET',axis_no, 1)+'Z4')
        data.append(motion.motor_motion_send_adr.get_motion_axis_position_send_adr('START',axis_no, 6))
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),20+10+axis_address_offset))
        data.append("")
        ...
        data.append("")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),20+11+axis_address_offset))
        data.append(motion.motor_motion_send_adr.get_motion_axis_SFC_pos_Send_adr('START',axis_no, axis_no))
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+axis_address_offset),3))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+axis_address_offset),4))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+axis_address_offset),8))
        ...
        data.append("")
        #POSITION_CHECK
        last_row=motion.ladder_mecro.export_partial_to_excel(ws,last_row,"POSITION_CHECK") 
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append(motion.motor_motion_send_adr.get_motion_axis_position_send_adr('START',axis_no, 6))
        data.append("K10")
        data.append("D800")
        ...
        data.append("K10")
        data.append("D802")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_monitor_recv_adr('START',axis_no, 0))
        ...
        data.append("")
        #MANUAL_CAMMAND
        last_row=motion.ladder_mecro.export_partial_to_excel(ws,last_row,"MANUAL_COMMAND") 
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        ...
        data.append("")
        data.append("ZR192")
        data.append(motion.motor_motion_send_adr.get_motion_axis_jogspeed_send_adr('START',axis_no, axis_no))
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+9+axis_address_offset),2))
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+0+axis_address_offset),3))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+0+axis_address_offset),9))
        ...
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+9+axis_address_offset),3))
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+0+axis_address_offset),3))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+0+axis_address_offset),9))
        ...
        data.append("")
        data.append("F40")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+9+axis_address_offset),4))
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),20+8+axis_address_offset))
        data.append("")
        ...
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+1+axis_address_offset),0))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+9+axis_address_offset),5))
        data.append("")
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+axis_address_offset),3))
        data.append("K0")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_monitor_recv_adr('START',axis_no,6))
        data.append("K0")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_monitor_recv_adr('START',axis_no,7))
        data.append("")
        ...
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+0+axis_address_offset),4))
        data.append("K0")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_monitor_recv_adr('START',axis_no,8))
        data.append("")
        ...
        data.append("")
        data.append(motion.motor_motion_recv_adr.get_motion_axis_monitor_recv_adr('START',axis_no,7))
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+17+axis_address_offset))
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+19+axis_address_offset),0))
        data.append(motion.motor_motion_send_adr.get_motion_axis_Command_send_adr('START',axis_no,2))
        ...
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+19+axis_address_offset),3))
        data.append(motion.motor_motion_send_adr.get_motion_axis_Command_send_adr('START',axis_no,7))
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+19+axis_address_offset),4))
        data.append(motion.motor_motion_send_adr.get_motion_axis_Command_send_adr('START',axis_no,8))
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+19+axis_address_offset),5))
        data.append(motion.motor_motion_send_adr.get_motion_axis_Command_send_adr('START',axis_no,15))
    else:
        print("-")
...
wb.save("motion_mecro_result1.xlsx")
wb.close()
print("✅ 저장 완료")
