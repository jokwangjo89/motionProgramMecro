...
excel_file ='PCB_MOTION_MECRO_MAP.xlsx'
...
################################# 2. D6부터 아래로 채울 데이터################################################
#wb = Workbook()
wb= load_workbook("motion_mecro_qd75_result.xlsx")
ws = wb.active
ws.title = "Exported"
data = []
last_row = 2
...
for j in range(10):
    ...
    if str(axis_no).isdigit():
        qd76d4_axis_start = motion.motor_param_adr_qd75.get_start_axis('START_AXIS',axis_no)-1
        cell = f'A{last_row}'
        ws[cell] = 'State'
        last_row=last_row+1
        data.append("")
        #MOTOR STATE
        last_row=motion.ladder_mecro_qd75.export_partial_to_excel(ws,last_row,"STATE") 
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append(add_bit_offset(motion.motor_param_adr_qd75.get_param_adr('EXT_IO_ADR',axis_no),1))
        ...
        data.append("")
        data.append(add_bit_offset(motion.motor_param_adr_qd75.get_param_adr('EXT_IO_ADR',axis_no),0))
        ...
        data.append("")
        data.append(add_bit_offset(motion.motor_param_adr_qd75.get_param_adr('EXT_IO_ADR',axis_no),6))
        ...
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_param_adr_qd75.get_param_adr('EXT_IO_ADR',axis_no),1),13))
        data.append(add_hex_offset(motion.motor_param_adr_qd75.get_param_adr('START_X_ADR',axis_no,qd76d4_axis_start),8))
        #data.append(motion.motor_param_adr_qd75.get_param_adr('START_X_ADR',axis_no,qd76d4_axis_start))
        data.append("")
        ...
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_param_adr_qd75.get_param_adr('EXT_IO_ADR',axis_no),1),3))
        ...
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_param_adr_qd75.get_param_adr('EXT_IO_ADR',axis_no),1),4))
        ...
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),10+scan_cnt),1))
        ...
        data.append("")
        data.append("F13")
        data.append(add_hex_offset(motion.motor_param_adr_qd75.get_param_adr('START_X_ADR',axis_no,qd76d4_axis_start),12))
        ...
        last_row=last_row+1
        #MOTOR ORIGIN
        last_row=motion.ladder_mecro_qd75.export_partial_to_excel(ws,last_row,"ORIGIN") 
        data.append("")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("F10")
        ...
        data.append("")
        #POSITION_INTERLOCK
        last_row=motion.ladder_mecro_qd75.export_partial_to_excel(ws,last_row,"POSITION_INTERLOCK")  
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),20+5+axis_address_offset))
        data.append("")
        ...
        data.append("")
        #POSITION_BIT
        last_row=motion.ladder_mecro_qd75.export_partial_to_excel(ws,last_row,"POSITION_BIT")  
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),20+2+axis_address_offset))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+ 4 +axis_address_offset),0))
        ...
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append(add_hex_offset(motion.motor_param_adr_qd75.get_param_adr('START_Y_ADR',axis_no,qd76d4_axis_start),16))
        ...
        data.append("")
        #POSITION_START
        last_row=motion.ladder_mecro_qd75.export_partial_to_excel(ws,last_row,"POSITION_START")  
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append(add_hex_offset(motion.motor_param_adr_qd75.get_param_adr('JOG_Y_ADR',axis_no,qd76d4_axis_start),8))
        data.append(add_hex_offset(motion.motor_param_adr_qd75.get_param_adr('JOG_Y_ADR',axis_no,qd76d4_axis_start),9))
        data.append("")
        data.append("K0")
        ...
        data.append("")
        #POSITION_MOVEMENT
        last_row=motion.ladder_mecro_qd75.export_partial_to_excel(ws,last_row,"POSITION_MOVEMENT")  
        data.append("K0")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+6+axis_address_offset))
        data.append("K0")
        ...
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+ 11 +axis_address_offset),0))
        data.append("K9001")
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('POSNO_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+11+axis_address_offset),0))
        data.append("K1")
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('POSNO_B_ADR',axis_no,qd76d4_axis_start)}")
        ...
        data.append("Z4")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+10+axis_address_offset))
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('MCODE_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append("")
        data.append("SM400")
        data.append(motion.motor_param_adr.get_param_adr('ACCTIME',axis_no))
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('ACC_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append(motion.motor_param_adr.get_param_adr('DECTIME',axis_no))
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('DEC_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append("")
        data.append("SM400")
        data.append("")
        data.append("L10")
        ...
        data.append("SM400")
        data.append("ZR186")
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('SPEED_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('SPEED_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('A_SPDLIMIT_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+11+axis_address_offset),0))
        ...
        data.append(motion.motor_pos_adr.get_pos_adr('TARGET',axis_no, 1)+'Z4')
        data.append(motion.motor_pos_adr.get_pos_adr('TARGET',axis_no, 1)+'Z4')
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('POSADR_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),20+10+axis_address_offset))
        data.append("")
        ...
        data.append("")
        #POSITION_CHECK
        last_row=motion.ladder_mecro_qd75.export_partial_to_excel(ws,last_row,"POSITION_CHECK")  
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('POSADR_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append("K10")
        data.append("D800")
        ...
        data.append("")
        #MANUAL_CAMMAND
        last_row=motion.ladder_mecro_qd75.export_partial_to_excel(ws,last_row,"MANUAL_COMMAND")  
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        ...
        data.append("")
        data.append("ZR192")
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('JOGSPD_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('JOGSPD_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('J_SPDLIMIT_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append(add_to_address(motion.motor_start_adr.get_start_adr('M_START',program_no),1+scan_cnt))
        data.append("")
        data.append("F10")
        data.append("")
        ...
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+19+axis_address_offset),2))
        data.append(add_hex_offset(motion.motor_param_adr_qd75.get_param_adr('START_Y_ADR',axis_no,qd76d4_axis_start),4))
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+19+axis_address_offset),3))
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+19+axis_address_offset),4))
        data.append("")
        data.append("K1")
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('RESET_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+19+axis_address_offset),5))
        data.append("K1")
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('SVOFF_B_ADR',axis_no,qd76d4_axis_start)}")
        data.append("")
        data.append(add_bit_offset(add_to_address(motion.motor_start_adr.get_start_adr('D_START',program_no),20+19+axis_address_offset),5))
        data.append("K0")
        data.append(f"{motion.motor_param_adr_qd75.get_param_adr('U_START',axis_no)}\{motion.motor_param_adr_qd75.get_param_adr('SVOFF_B_ADR',axis_no,qd76d4_axis_start)}")
...
wb.save("motion_mecro_qd75_result.xlsx")
wb.close()
print("✅ 저장 완료")
