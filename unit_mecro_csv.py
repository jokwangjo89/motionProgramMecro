...
excel_file ='PCB_UNIT_MECRO_MAP.xlsx'
...
data.append("M901")
data.append("")
data.append(add_to_address((unit.get_unit_adr.get_start_adr(program_no,"STATUS","M_START")),291))
cell = f'A{last_row}'
...
for i in range(cyl_m_cnt):
    ...
    data.append("")
    data.append(add_to_address(unit.get_unit_adr.get_start_adr(program_no,"ERROR","CYL_START"),0+i))
    data.append("")
